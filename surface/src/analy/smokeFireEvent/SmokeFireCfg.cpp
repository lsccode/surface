...
SmokeFireCfg::SmokeFireCfg(QWidget *parent):QWidget(parent)
{
...
void SmokeFireCfg::createListWidgetIcons()
{
...
void SmokeFireCfg::changePage(QListWidgetItem *current, QListWidgetItem *previous)
{
    if (!current)
        current = previous;
