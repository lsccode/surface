...
PedestrCfg::PedestrCfg(QWidget *parent):QWidget(parent)
{
...
void PedestrCfg::createListWidgetIcons()
{
...
void PedestrCfg::changePage(QListWidgetItem *current, QListWidgetItem *previous)
{
    if (!current)
        current = previous;
