...
CameraCfg::CameraCfg(QWidget *parent):QWidget(parent)
{
...
void CameraCfg::createListWidgetIcons()
{
...
void CameraCfg::changePage(QListWidgetItem *current, QListWidgetItem *previous)
{
    if (!current)
        current = previous;
