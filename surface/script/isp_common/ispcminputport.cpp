    ...
    QWidget(parent)
{
    ...
    ptEdit_reg_hc_size0  = new QLineEdit("0000d5cb");
    ...
    ptEdit_reg_preset  = new QLineEdit("00104002");
    ...
    ptEdit_reg_vc_start  = new QLineEdit("0000d19c");
...
{
    QString str_FrStatusReset = ptEdit_FrStatusReset->text();
    QString str_FrStatusHold = ptEdit_FrStatusHold->text();
    QString strt_reg_hc_limit = ptEdit_reg_hc_limit->text();
    QString str_reg_hc_size0 = ptEdit_reg_hc_size0->text();
    QString str_reg_hc_size1 = ptEdit_reg_hc_size1->text();
    QString str_reg_mode_request = ptEdit_reg_mode_request->text();
    QString str_reg_preset = ptEdit_reg_preset->text();
    QString str_reg_vc_start = ptEdit_reg_vc_start->text();
