...
#include "nvtH.h"	/* replace with soapcpp2-generated *H.h file */
#include "smdevp.h"
#include "mecevp.h"
...
int soap_wsse_add_UsernameTokenDigestCreated(struct soap *soap, const char *id, const char *username, const char *password,const char *created);
