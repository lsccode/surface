/* nvtNotificationConsumerBindingProxy.h
...
#ifndef nvtNotificationConsumerBindingProxy_H
#define nvtNotificationConsumerBindingProxy_H
#include "nvtH.h"
...
{ public:
	...
	virtual	int recv_Notify(struct __remote7__Notify&);
