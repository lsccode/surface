/* nvtDiscoveryLookupBindingProxy.h
...
#ifndef nvtDiscoveryLookupBindingProxy_H
#define nvtDiscoveryLookupBindingProxy_H
#include "nvtH.h"
...
{ public:
	...
	DiscoveryLookupBindingProxy(const char *url);
	/// Constructor with engine input+output mode control
	DiscoveryLookupBindingProxy(soap_mode iomode);
	/// Constructor with URL and input+output mode control
	DiscoveryLookupBindingProxy(const char *url, soap_mode iomode);
