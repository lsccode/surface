    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->tabWidget->setTabIcon(0,QIcon("E:\\workSpace\\nvpsdk\\QTabWidget\\1.ico"));//设置选项卡图标
    ui->tabWidget->setTabIcon(1,QIcon("E:\\workSpace\\nvpsdk\\QTabWidget\\2.ico"));//设置选项卡图标
    ui->tabWidget->setTabIcon(2,QIcon("E:\\workSpace\\nvpsdk\\QTabWidget\\3.ico"));//设置选项卡图标
    ui->tabWidget->setTabIcon(3,QIcon("E:\\workSpace\\nvpsdk\\QTabWidget\\4.ico"));//设置选项卡图标
    ui->tabWidget->setTabIcon(4,QIcon("E:\\workSpace\\nvpsdk\\QTabWidget\\5.ico"));//设置选项卡图标
    ui->tabWidget->setIconSize(QSize(100,25));//设置图标的大小(选项卡的大小也会改变)
